...
final String updateCartItemUrl = 'update-cart-item';
final String deleteCartItemUrl = 'delete-Cart-Item';
final String deleteAllCartItemsUrl = 'delete-all-cart-items';
